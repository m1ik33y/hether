    ...
    if (user) {
      ...
      const globalGroupCh = supabaseClient.channel(`global-inbox-groups:${user.id}`)
        .on('postgres_changes', { event: 'INSERT', schema: 'public', table: 'messages' }, (payload) => {
          ...
          // always attempt it — that's what makes the sound fire when this
          // group is open but the tab is just backgrounded.
          ...
          if (msg.group_id === activeFluxId) {
            ...
            // lastMessage there. Never mark unread/bump the dot count for
            // a chat the user currently has open, regardless of tab
            // visibility.
            return;
          }
